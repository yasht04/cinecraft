...
//                                     Application Example - "Casablanca": 
...
//                                     - Purpose:The scene serves to deepen the relationship between the characters and explore the theme of friendship evolving into something more. 
//                                     - Conflict:The underlying conflict is the tension and uncertainty surrounding the potential romantic feelings between Harry and Sally. 
//                                        
...
//                                      - Rising Action:   The narrative intensifies as characters confront obstacles and conflicts escalate. In "The Dark Knight," Batman faces escalating challenges posed by the Joker, driving the story into the heart of chaos.
//                                      
//                                      - Midpoint:   A pivotal moment that shifts the story in a new direction. In "The Godfather," the midpoint involves the failed assassination attempt on Vito Corleone. This event propels Michael into a more active role within the family business.
//                                      
//                                      - Character Development:   Act 2 provides opportunities for characters to evolve. In "Forrest Gump," Forrest's journey through Vietnam showcases his resilience and impacts the development of those around him.
//                                      
//                                       - Crisis or Low Point:   A moment of despair or failure that heightens tension. In "The Empire Strikes Back," the low point occurs when Luke Skywalker learns the truth about his parentage and suffers a devastating defeat at the hands of Darth Vader.
//                                      
//                                     <h5>Act 3: Resolution</h5>
//                                      - Climax:   The highest point of tension where the central conflict reaches its peak. In "Jurassic Park," the climax involves the characters' desperate attempt to escape the island amidst a dinosaur rampage.
//                                      
//                                      - Character Transformation:   Protagonists undergo significant changes. In "The Shawshank Redemption," Andy Dufresne's escape not only resolves the plot but symbolizes his transformation from prisoner to a symbol of hope.
//                                      
//                                      - Resolution of Conflicts:   Loose ends are tied up, and conflicts find resolution. In "Casablanca," Rick sacrifices his love for Ilsa for the greater good, resolving the film's central romantic and political conflicts.
//                                      
//                                      - Denouement:    The aftermath that reveals the consequences and the new equilibrium. In "Titanic," the denouement shows the elderly Rose reflecting on her past and the impact of her brief but intense love affair.
//                                      
...
//                                      Action Lines: 
//                                      
//                                      - Formatting:  Action lines, also known as narrative description, are written in sentence case and are usually limited to four lines to maintain readability. They describe the actions, movements, and visual details within a scene. For example:
//                                     ```
...
//                                      
//                                     <h5> 1. Punctuation:</h5>
//                                     -  Quotation Marks:    Dialogue is enclosed within double quotation marks. Single quotation marks are reserved for quotes within dialogue.
//                                     ```
//                                      
//                                     JANE
...
//                                     ```
//                                      
//                                      - Clarity and Brevity: Keep parentheticals concise, focusing on essential details. Overuse can disrupt the flow of dialogue.
//                                        
...
//                                     JOHN  
//                                     (pauses)
//                                     Well, now we're in deeper trouble.  
